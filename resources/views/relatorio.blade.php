                        ...
                        <div class="container">
                            ...
                            <div class="container">
                                <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker"
                                    inline="true">
                                    <input placeholder="Select date" type="date" id="created_at" name="datainicial" class="form-control">
            ...
            <div class="container">
                ...
                <div class="container">
                    <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                        <input placeholder="Select date" type="date" id="created_at" name="datafinal" class="form-control">
                        <i class="fas fa-calendar input-prefix"></i>
                    </div>
